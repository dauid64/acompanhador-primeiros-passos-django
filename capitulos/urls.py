...
from capitulos.views import CapituloDetailView, DificuldadeUpdateView, NotaUpdateView, ExercicioUsuarioDetailView, FeitoUpdateView
...
urlpatterns = [
    ...
    path("<int:pk>/feito/", FeitoUpdateView.as_view(), name="feito_update"),
